package com.me.wavesslidebarview
...
class WaveSideBarView @JvmOverloads constructor(
    ...
    init {
        ...
        val typedArray =
            context.obtainStyledAttributes(attrs, R.styleable.WaveSideBarView)
        mLazyRespond =
            typedArray.getBoolean(R.styleable.WaveSideBarView_sidebar_lazy_respond, false)
        mTextColor = typedArray.getColor(
            R.styleable.WaveSideBarView_sidebar_text_color,
            Color.GRAY
        )
        mMaxOffset = typedArray.getDimension(
            R.styleable.WaveSideBarView_sidebar_max_offset,
            dp2px(DEFAULT_MAX_OFFSET)
        )
        mSideBarPosition = typedArray.getInt(
            R.styleable.WaveSideBarView_sidebar_position,
            POSITION_RIGHT
        )
        mTextAlignment = typedArray.getInt(
            R.styleable.WaveSideBarView_sidebar_text_alignment,
            TEXT_ALIGN_CENTER
        )
        typedArray.recycle()
